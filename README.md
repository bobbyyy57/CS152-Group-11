...
| Assignment Statements | x `:point_right:` `:eight:`; <br /> y `:point_right:` `:seven:`; |x 👉 `:eight:`; <br /> y 👉 `:seven:`; |
...
| While or Do-While Loops | `:repeat:`[x `:arrow_backward:` `:eight:`] : {} <br />(do while x is less than 8) |  🔁[x ◀️ `:eight:`] : (do while x is less than 8) | 
